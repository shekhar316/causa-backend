 ...
 *
 * <p>REST endpoints for reading diagnostic analysis results.
 * <ul>
 *   <li>GET /api/v1/diagnostics         — list all diagnostics (summary)</li>
 *   <li>GET /api/v1/diagnostics/{id}    — full diagnostic detail</li>
 * </ul>
 *
 * @since 0.0.1
 */
...
public class DiagnosticsController {
    ...
    /**
     * Returns a summary list of all diagnostics.
     *
     * <p>Each item contains: id, issue (title), container_name, namespace, severity, cluster_name, date.
     *
     * @return 200 with list of DiagnosticListItemResponse
     */
    @GET
    ...
    public Response listDiagnostics() {
        ...
        String clusterName = appConfig.getClusterConfig().getClusterName().orElse("default");
    ...
    /**
     * Returns the full diagnostic detail for a given diagnostic ID.
     *
     * @param diagnosticId the diagnostic ID (path parameter)
     * @return 200 with DiagnosticDetailResponse, 404 if not found
     */
    @GET
    ...
    public Response getDiagnostic(
        ...
        DiagnosticDetailResponse detail = DiagnosticDetailResponse.from(diagnostic, alert, clusterName);
