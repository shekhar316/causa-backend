...
public final class AlertConstants {
     ...
     *
     * <p>Used by POST /api/v1/alerts to synthesise a webhook-compatible alert.
     */
    public static final class ManualTrigger {
        private ManualTrigger() {}

        /** Prefix for alert names generated by the manual trigger. */
        public static final String ALERT_NAME_PREFIX = "manual-analysis-trigger";

        /** Value placed in {@code alert_source} annotation for manual triggers. */
        public static final String ALERT_SOURCE = "manual-trigger";

        /** Default severity when none is supplied in the trigger request. */
        public static final String DEFAULT_SEVERITY = "critical";

        /** Synthetic Alertmanager receiver name. */
        public static final String WEBHOOK_RECEIVER = "manual-trigger";
    }
