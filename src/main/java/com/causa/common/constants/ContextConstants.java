...
public final class ContextConstants {
    ...
    // -------------------------------------------------------------------------
    // Cluster platform section headers
    // -------------------------------------------------------------------------
    public static final String SECTION_POD_STATUS              = "POD STATUS (Kubernetes)";
    public static final String SECTION_POD_EVENTS              = "POD EVENTS (Kubernetes)";
    public static final String SECTION_POD_LOGS                = "POD LOGS (Kubernetes, recent)";
    ...
    public static final String SECTION_VM_HEAP_STATUS          = "HEAP STATUS (Java JMX MCP)";
    public static final String SECTION_VM_GC_ACTIVITY          = "GC ACTIVITY (Java JMX MCP)";
    public static final String SECTION_VM_THREAD_STATE         = "THREAD STATE (Java JMX MCP)";
    public static final String SECTION_VM_GC_PRESSURE          = "GC PRESSURE ANALYSIS (Java JMX MCP)";
    public static final String SECTION_VM_MEMORY_LEAK          = "MEMORY LEAK INDICATORS (Java JMX MCP)";
    public static final String SECTION_VM_THREAD_CONTENTION    = "THREAD CONTENTION ANALYSIS (Java JMX MCP)";
    public static final String SECTION_VM_JVM_RUNTIME_INFO     = "JVM RUNTIME INFO (Java JMX MCP)";
}
